        ...
        <div class="breadcrumb col-mg-2">
            <div class="formio">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                       <asp:TextBox ID="TextBox2" runat="server" MaxLength="140" Rows="6" TextMode="MultiLine" ValidationGroup="btncurso" placeholder="Ingrese los mails separados por coma(,)"></asp:TextBox> 
                    </div>
                </div>
                <div class="controls">
